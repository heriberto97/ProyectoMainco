...
public class Compras implements Initializable {
    ...
    void iniciar_nueva_compra(){
        try {
            ...
            if (contador>0) {
                ...
                FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("Nueva_Compra.fxml"));
                ...
                Notifications noti = Notifications.create()
                        ...
                        .text("Haz clic aquí para registrar uno.")
                        .graphic(new ImageView(img))
    ...
    void iniciar_detalles_compra(){
        try
        {
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("Detalles_Compra.fxml"));
            Parent abrir = fxmlLoader.load();
    ...
    void iniciar_nuevo_proveedor(){
        try
        {
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("Nuevo_Proveedor.fxml"));
            Parent abrir = fxmlLoader.load();
