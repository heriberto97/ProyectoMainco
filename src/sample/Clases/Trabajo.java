...
public class Trabajo implements Initializable {
    ...
    @FXML void nuevo_cliente(){
        ...
        try
        {
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("Nuevo_Cliente.fxml"));
    ...
    @FXML void subir_ordencompra() {
        try
        {
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("Trabajos_OrdenCompra.fxml"));
            Parent abrir = fxmlLoader.load();
            if (ventana_nuevo_cliente.getScene() == null) {
    ...
    @FXML void seleccionar_esquema() {
        try
        {
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("Trabajo_Esquema.fxml"));
            Parent abrir = fxmlLoader.load();
            if (ventana_nuevo_cliente.getScene() == null) {
    ...
    @FXML void subir_cotizacion() {
        try
        {
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("Trabajo_Cotizacion.fxml"));
            Parent abrir = fxmlLoader.load();
            if (ventana_nuevo_cliente.getScene() == null) {
