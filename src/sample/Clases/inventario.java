...
public class inventario {
    ...
    public void abriroficina(javafx.event.ActionEvent event)
    {
        ...
        try
        {
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("inventario_oficina.fxml"));
    ...
    public void abrirproductos(javafx.event.ActionEvent event)
    {
        ...
        try
        {
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("inventario_productos.fxml"));
            Parent abrir = fxmlLoader.load();
