...
public class producto_seleccionado implements Initializable {
    ...
    String numero_id;
    @FXML Button btn_guardar_descripcion,btn_guardar_esquema,btn_guardar_file,btn_guardar_material,btn_guardar_peso,btn_guardar_asignacion;
    @FXML
    ...
    String reg;
    @FXML
    TextField txt_numero,txt_peso2;
    @FXML
